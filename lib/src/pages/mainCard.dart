      ...
      children: <Widget>[
        Row(
          ...
          children: <Widget>[
            ...
            Text('Rs ' + transLimit.toStringAsFixed(0), style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w700),)
          ],
        ),
        SliderTheme(
            ...
            children: <Widget>[
              Column(
                ...
                children: <Widget>[
                  ...
                  Text('Rishav Raj Jain', style: TextStyle(color: fCD, fontSize: 18, fontWeight: FontWeight.w700)),
                ],
              ),
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
